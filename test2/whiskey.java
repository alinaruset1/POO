...
class JackAndHoney extends Whiskey{
    private double concentratie;
    private int cantitate_indulcitor;
    public JackAndHoney(String nume, double concentratie, int cantitate_indulcitor)
    {
        super(nume);
        this.concentratie=concentratie;
        this.cantitate_indulcitor=cantitate_indulcitor;
    }

    public double getNrCalorii(double ml)
    {
        return concentratie*ml*5+cantitate_indulcitor*ml*15;
    }
    public double getConcentratieAlcool(){
        return this.concentratie;
    }
    ...
    {
        String sir="";
        sir=sir+"Nume: " +this.getNume()+"Concentratie alcool: "+concentratie+"%, Calorii pe 100 ml:" + this.getNrCalorii(100)+ "kcal "+"Cantitate indulcitor: "+cantitate_indulcitor+"g";
        return sir;
    }
...
class Main{
    public static void main(String[] args) {
        ...
        JackAndHoney w2= new JackAndHoney("W2",0.20,15);
